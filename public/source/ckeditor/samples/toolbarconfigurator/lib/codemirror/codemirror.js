(function (q) {
    ...
    function Kc(a) {
        for (var b = a.display, c = {}, d = {}, e = b.gutters.clientLeft,
                f = b.gutters.firstChild, g = 0; f; f = f.nextSibling, ++g)
    ...
    function yf(a, b) {
        var c = {ranges: b.ranges, update: function (b) {
                this.ranges = [];
        ...
        if (!(b.frontier >= a.display.viewTo)) {
            ...
            b.iter(b.frontier, Math.min(b.first + b.size, a.display.viewTo +
                ...
                if (b.frontier >= a.display.viewFrom) {
                    ...
                    Zc(a, f.text, d), f.stateAfter = 0 == b.frontier % 5 ? Sa(b.mode, d) : null;
                ++b.frontier;
                if (+new Date > c)
    ...
    function sf(a) {
        ...
        d.dragFunctions = {simple: function (b) {
                ja(a, b) || jd(b)
            }, start: function (b) {
    ...
    function pe(a) {
        ...
        if (!(b.activeTouch && b.input.supportsTouch() || ja(this, a)))
            if (b.shift = a.shiftKey, oa(b, a))
                J || (b.scroller.draggable = !1, setTimeout(function () {
    ...
    function Sd(a, b) {
        var c = t("span",
                null, null, J ? "padding-right: .1px" : null), c = {pre: t("pre", [c]), content: c, col: 0, pos: 0, cm: a, splitSpaces: (B || J) && a.getOption("lineWrapping")};
        b.measure = {};
    ...
    function ja(a, b, c) {
        "string" ==
                typeof b && (b = {type: b, preventDefault: function () {
    ...
    Gc.prototype = V({update: function () {
    ...
    q.prototype = {constructor: q, focus: function () {
            window.focus();
    ...
    Ya(q);
    var qf = q.defaults = {}, Ka = q.optionHandlers = {}, Fd = q.Init = {toString: function () {
    ...
    var ic = q.commands = {selectAll: function (a) {
    ...
    P.prototype = ff(Cb.prototype, {constructor: P, iter: function (a, b, c) {
        ...
        somethingSelected: function () {
            ...
            for (var a =
                    this.history, b = 0, c = 0, d = 0; d < a.done.length; d++)
                a.done[d].ranges || ++b;
    ...
    var O = q.e_preventDefault = function (a) {
        ...
        if (c)
            ...
            null, Hd = 30, Ae = q.Pass = {toString: function () {
