 ...
 */
        (function () {
            ...
            var f, k, t, p, m = CKEDITOR.tools, y = ["o:p", "xml", "script", "meta", "link"], z = "v:arc v:curve v:line v:oval v:polyline v:rect v:roundrect v:group".split(" "), w = {},
                    v = 0;
            ...
            CKEDITOR.cleanWord = function (a, b) {
                ...
                var g = CKEDITOR.htmlParser.fragment.fromHtml(a), h = {root: function (a) {
                        a.filterChildren(p);
                        CKEDITOR.plugins.pastefromword.lists.cleanup(f.createLists(a))
                    }, elementNames: [[/^\?xml:namespace$/, ""], [/^v:shapetype/, ""], [new RegExp(y.join("|")), ""]], elements: {a: function (a) {
                            ...
                            k.mapStyles(a, {width: function (b) {
                            ...
                            var b = a.attributes["v:shapes"] ? a.attributes["v:shapes"].split(" ") : [], c = CKEDITOR.tools.array.every(b, function (a) {
                            ...
                            if (f.thisIsAListItem(b, a))
                                t.isEdgeListItem(b, a) && t.cleanupEdgeListItem(a), f.convertToFakeListItem(b, a), m.array.reduce(a.children, function (a, b) {
                        ...
                        h1: function (a) {
                            ...
                            if (d)
                                return"li" == a.parent.name && 0 === m.indexOf(a.parent.children, a) && k.setStyle(a.parent,
                            ...
                            if (d)
                                return"li" == a.parent.name && 0 === m.indexOf(a.parent.children, a) && k.setStyle(a.parent, "list-style-type", "none"), f.dissolveList(a), !1
                        }, span: function (a) {
                            a.filterChildren(p);
                            ...
                            var c = a.getAscendant("table"), d = c._tdBorders, e = ["border", "border-top", "border-right", "border-bottom", "border-left"], c = m.parseCssText(c.attributes.style), g = c.background || c.BACKGROUND;
                        ...
                        "v:shapes": u, "o:spid": u}, comment: function (a) {
            ...
            CKEDITOR.plugins.pastefromword.styles =
                    {setStyle: function (a, b, c, d) {
                            ...
                            var c = "background-color:transparent border-image:none color:windowtext direction:ltr mso- text-indent visibility:visible div:border:none".split(" "),
                                    d = "font-family font font-size color background-color line-height text-decoration".split(" "), e = function () {
                            ...
                            for (var b = ["border", "border-bottom", "font-size", "background"], c = m.parseCssText(a.attributes.style), d = m.objectKeys(c), e = [], g = [], h = 0; h < d.length; h++)
                                -1 !==
                            ...
                            if (!a.attributes.style || 0 === a.children.length)
                                return!1;
                            b = b || {};
                            var d = {"list-style-type": !0, width: !0, height: !0, border: !0, "border-": !0}, e = m.parseCssText(a.attributes.style), g;
                            for (g in e)
                                if (!(g.toLowerCase()in
                            ...
                            parse: function (a) {
                                ...
                                var d = CKEDITOR.tools.parseCssText, e = CKEDITOR.plugins.pastefromword.styles.inliner.filter, g = a.is ? a.$.sheet : b(a);
                                a = [];
                                var h;
                                if (g)
                                ...
                                return a.sort(function (a) {
                                    ...
                                    return function (a, b) {
                                        var g = -1 !== ("" + a.selector).indexOf(".") ? 1 : 0, g = (-1 !== ("" + b.selector).indexOf(".") ? 1 : 0) - g;
            ...
            CKEDITOR.plugins.pastefromword.lists = {thisIsAListItem: function (a, b) {
                ...
                setListSymbol: function (a, b, c) {
                    ...
                    if ("ol" == a.name) {
                        if (a.attributes.type || d["list-style-type"])
                            return;
                        var e = {"[ivx]": "lower-roman", "[IVX]": "upper-roman", "[a-z]": "lower-alpha", "[A-Z]": "upper-alpha", "\\d": "decimal"}, g;
                        for (g in e)
                        ...
                        e = {"·": "disc", o: "circle", "§": "square"}, !d["list-style-type"] && e[b] && (d["list-style-type"] =
                                e[b]);
                    ...
                    delete a.attributes["cke-list-style-type"]
                }, numbering: {toNumber: function (a, b) {
                        function c(a) {
                            a = a.toUpperCase();
                        ...
                        function d(a) {
                            ...
                            for (var c = b.length, d = 0, f = 0; f < c; ++f)
                                for (var n = b[f], r = n[1].length; a.substr(0, r) == n[1]; a = a.substr(r))
                                    d += n[0];
                            return d
                        }
                        ...
                        a = a.slice(0, 1);
                        var b = {i: "lower-roman", v: "lower-roman", x: "lower-roman", l: "lower-roman", m: "lower-roman", I: "upper-roman", V: "upper-roman", X: "upper-roman", L: "upper-roman",
                            M: "upper-roman"}[a];
                    ...
                    for (g = a; 0 <= g && null === c; g--)
                        e = b.children[g], e.attributes && void 0 !== e.attributes.value && (d = g, c = parseInt(e.attributes.value, 10));
                    ...
                    var c = a.toUpperCase() == a ? "upper-" : "lower-", d = {"·": ["disc", -1], o: ["circle", -2], "§": ["square", -3]};
                    ...
                    return!b && a.match(/[ivxl]+/i) || b && "alpha" != b || "roman" == b ? {index: f.toArabic(a), type: c +
                                "roman"} : a.match(/[a-z]/i) ? {index: a.charCodeAt(0) - 97, type: c + "alpha"} : {index: -1, type: "disc"}
            ...
            CKEDITOR.plugins.pastefromword.images = {extractFromRtf: function (a) {
                    var b = [], c = /\{\\pict[\s\S]+?\\bliptag\-?\d+(\\blipupi\-?\d+)?(\{\\\*\\blipuid\s?[\da-fA-F]+)?[\s\}]*?/, d;
                    ...
                    for (var e = 0; e < a.length; e++)
                        if (c.test(a[e])) {
                            if (-1 !== a[e].indexOf("\\pngblip"))
                                ...
                                continue;
                            b.push({hex: d ? a[e].replace(c, "").replace(/[^\da-fA-F]/g,
                                        "") : null, type: d})
                        }
                    return b
            ...
            CKEDITOR.plugins.pastefromword.heuristics = {isEdgeListItem: function (a, b) {
                    ...
                    if (!b.attributes || void 0 === b.attributes["cke-list-level"]) {
                        for (var c = [f.getElementIndentation(b)], d = [b], e = [], g = CKEDITOR.tools.array, h = g.map; b.next && b.next.attributes && !b.next.attributes["cke-list-level"] && t.isDegenerateListItem(a, b.next); )
