 ...
 */
        (function () {
            ...
            function q(c, g) {
                ...
                u.prototype = {toDomRange: function () {
                ...
                z.prototype = {feedCharacter: function (a) {
                ...
                var D = /[.,"'?!;: \u0085\u00a0\u1680\u280e\u2028\u2029\u202f\u205f\u3000]/,
                        ...
                        }, e = {searchRange: null, matchRange: null, find: function (a, b, d, f, e, E) {
                        ...
                        if (!this.matchRange || !this.matchRange.isMatched() || this.matchRange._.isReplaced || this.matchRange.isReadOnly() || a)
                            a && this.matchRange && (this.matchRange.clearMatched(), this.matchRange.removeHighlight(), this.matchRange = null), a = this.find(b, f, e, g, !k);
                        else {
                            this.matchRange.removeHighlight();
                ...
                return{title: f.title, resizable: CKEDITOR.DIALOG_RESIZE_NONE,
